//<![CDATA[
imgr = new Array();
imgr[0] = "https://chinesefontdesign.com/wp-content/uploads/2014/04/09.png";
showRandomImg = true;
aBold = true;
summaryPost = 400;
summaryTitle = 20;
...
function related_results_labels_thumbs(json) {
    for (var i = 0; i < json.feed.entry.length; i++) {
        ...
        try {
            ...
            } else thumburl[relatedTitlesNum] = 'https://chinesefontdesign.com/wp-content/uploads/2014/04/09.png'
        }
